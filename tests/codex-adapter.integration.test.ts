// Integration test against the REAL Codex CLI (OpenAI). Gated:
//   FOUNCODE_IT=1 npx vitest run tests/codex-adapter.integration.test.ts
...
describe.skipIf(!enabled)('CodexAdapter (real CLI)', () => {
